...
With a single Zoqq account and/or one integration, you (and your customers) can move funds globally via Zoqq’s payout network, which currently supports:

- **Local and SWIFT payouts**
- **170 countries/regions**
- **Over 60 currencies**

👉 _Find out more about our [Payout Network](#)_
...
🔹 **Sign up** for a [Zoqq account](#) to begin.

🔹 Want to try before going live?  
...
📧 We’ll email you once your demo account is prepared.
...
| VND           | Vietnamese đồng           | Viet Nam                                                                       | 0                 |
| XAF           | Central African CFA franc | Cameroon, Central African Republic, Chad, Congo (Republic), Equatorial Guinea, Gabon | 0                 |
| XOF           | West African CFA franc    | Benin, Burkina Faso, Côte d'Ivoire, Guinea-Bissau, Niger, Senegal, Togo       | 0                 |
...
👉 For detailed request requirements for each payout scenario, see our **[dynamic schema](#)**.
...
📘 Refer to **[Create a transfer to a Zoqq account](#)** to learn how it works.
...
- **France**: Including French Guiana, Guadeloupe, Réunion, Saint Barthélemy, and Saint Martin (French part)  
